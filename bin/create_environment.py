...
if __name__ == '__main__':
    ...
    print 'If you are checking into svn, make sure you don''t check in \
            the env directory.  You can run `svn propset svn:ignore -F .svnignore .`'
    if sys.platform == 'win32':
        print 'Remember to source your environment via \
                %s/Scripts/activate.bat before doing anything' % (ENV_DIR)
    else:
        print 'Remember to source your environment via \
                %s/bin/activate before doing anything' % (ENV_DIR)
